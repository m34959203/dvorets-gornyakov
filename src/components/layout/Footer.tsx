      ...
      <div className="dg-wrap">
        <div className="dg-footer-top">
          ...
          <div className="dg-foot-col dg-foot-about">
            ...
            <p>
              {T(
                "«Ш. Ділдебаев атындағы Тау-кеншілер сарайы» коммуналдық мемлекеттік қазыналық кәсіпорны — Ұлытау облысы мәдениет басқармасы",
        ...
        <div className="dg-foot-credit">
          {T(
            "Карточкаларға арналған иллюстрациялар Мәдениет сарайының концерттік қызметінің мәтіндік сипаттамалары негізінде нейрожелі арқылы жасалған. Деректі фотосуреттер емес.",
            "Иллюстрации для карточек сгенерированы нейросетью на основе текстовых описаний концертной деятельности Дворца. Не являются документальной фотографией."
          )}
        </div>
