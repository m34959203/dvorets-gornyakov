...
export default function AdminSidebar({ locale, messages }: AdminSidebarProps) {
  ...
  const menuItems = [
    ...
    { href: `/${locale}/admin/events`, label: t.events, icon: "M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" },
    { href: `/${locale}/admin/enrollments`, label: t.enrollments, icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" },
    { href: `/${locale}/admin/rent/requests`, label: t.rentRequests, icon: "M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" },
    { href: `/${locale}/admin/rent/halls`, label: t.rentHalls, icon: "M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4" },
    { href: `/${locale}/admin/bookings`, label: locale === "kk" ? "Зал брондау" : "Бронь залов", icon: "M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" },
    ...
    <aside className="w-64 bg-gray-900 text-gray-300 min-h-screen flex flex-col">
      ...
      <div className="p-4 border-b border-gray-800">
        <Link href={`/${locale}/admin`} className="flex items-center gap-3">
          ...
          <span className="font-bold text-white text-sm">{t.dashboard}</span>
        </Link>
      </div>
      ...
      <div className="p-3 border-t border-gray-800">
        <Link
          href={`/${locale}`}
          className="flex items-center gap-3 px-3 py-2.5 text-sm text-gray-400 hover:text-white hover:bg-gray-800 rounded-lg transition-colors"
        >
          <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M10 19l-7-7m0 0l7-7m-7 7h18" />
          </svg>
          {locale === "kk" ? "Сайтқа оралу" : "Вернуться на сайт"}
        </Link>
      </div>
    </aside>
  );
