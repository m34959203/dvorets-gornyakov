// Фолбэк-обложки для событий и кружков, когда у записи в БД пустой image_url.
// AI-иллюстрации (Gemini), сгенерированы по текстовым описаниям деятельности Дворца —
// не документальные фото. Лежат в public/photos/. Маппинг — dvorets-images-pack/MAPPINGS.md.
