  ...
  return (
    <div className="dg-home">
      ...
      <section className="section section--light">
        <div className="dg-wrap">
          <div className="about-grid">
            <div className="about-photo" style={{ aspectRatio: "3 / 4" }}>
              <Image
                src="/portrait/dildebaev.webp"
                alt={T("Шынболат Ділдебаев (1937–1998)", "Шынболат Дильдебаев (1937–1998)")}
                fill
                sizes="(max-width: 960px) 100vw, 45vw"
              />
              <div className="about-photo-tag">{T("1937 — 1998", "1937 — 1998")}</div>
            </div>
            ...
            <div className="about-text">
              ...
              <p style={{ marginTop: 28 }}>
                ...
                {T(
                  " — ақын-импровизатор, термеші, айтыскер әрі домбырашы, қазақ даласының жыраулық және терме дәстүрін жалғастырушы. 1937 жылы 22 сәуірде Қызылорда облысы Шиелі ауданының Сұлутөбе ауылында дүниеге келген.",
                  " — акын-импровизатор, термеши, айтыскер и домбрист, продолжатель степной традиции жырау и терме. Родился 22 апреля 1937 года в селе Сулутобе Шиелийского района Кызылординской области."
                )}
              </p>
              <p>
                {T(
                  "Отыз жылдан астам уақыт Жезқазған кенішінің №45 шахтасында кенші әрі ауысым шебері болып еңбек етіп, ауыр жұмысты ақындықпен ұштастырды. 1980 жылдардан бастап республикалық ақындар айтысының тұрақты жүлдегері, шебер термеші ретінде танылды. «Шындық» толғауы мен «Кенші сыры» (1993), «Жылжиды жылдар» (1997) жинақтары қазақтың ауызша поэзиясының қазынасына қосылды.",
                  "Более тридцати лет он работал горняком и сменным мастером на шахте №45 Жезказганского рудника, совмещая нелёгкий труд с поэзией. С 1980-х годов — постоянный призёр республиканских айтысов и признанный мастер терме. Его толгау «Шындық» («Истина») и сборники «Кенші сыры» (1993) и «Жылжиды жылдар» (1997) вошли в сокровищницу казахской устной поэзии."
                )}
              </p>
              <p>
                {T(
                  "Ұлт мәдениетіне қосқан үлесі үшін «Қазақстан Республикасының еңбек сіңірген мәдениет қызметкері» атағына ие болды (1991); Сәтбаев, Қызылорда, Ақтөбе қалаларының және Шиелі ауданының құрметті азаматы атанды. Ақын 1998 жылы 7 қарашада Сәтбаев қаласында дүниеден өтті. 2001 жылы Сарай жанынан оның музейі ашылды, ал мекеме бүгінде Шынболат Ділдебаевтың есімін мақтанышпен алып жүр.",
                  "За вклад в национальную культуру удостоен звания «Заслуженный работник культуры Республики Казахстан» (1991); избран почётным гражданином городов Сатпаев, Кызылорда, Актобе и Шиелийского района. Поэт ушёл из жизни 7 ноября 1998 года в Сатпаеве. В 2001 году при Дворце открыт его музей, а само учреждение сегодня с гордостью носит имя Шынболата Дильдебаева."
                )}
              </p>
            </div>
          </div>
