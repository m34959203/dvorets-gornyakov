          ...
          <div className="about-grid">
            ...
            <div className="about-text">
              ...
              <p style={{ marginTop: 28 }}>
                ...
                {T(
                  " — ақын-импровизатор әрі термеші, қазақ даласының ауызша поэтикалық дәстүрін жалғастырушы. Айтыс пен терме өнері арқылы ол халықтың тірі сөзін сақтап, оны жаңа ұрпаққа жеткізді.",
                  " — акын-импровизатор и термеши, носитель устной поэтической традиции казахской степи. Искусством айтыса и терме он сохранял живое слово и передавал его новым поколениям."
                )}
              </p>
              <p>
                {T(
                  "Ұлт мәдениетіне қосқан үлесі үшін «Қазақстан Республикасының еңбек сіңірген мәдениет қызметкері» атағына ие болды (1991), Сәтбаев, Қызылорда және Ақтөбе қалаларының құрметті азаматы атанды. 2001 жылы Сарай жанынан ақынның музейі ашылды, ал мекеме бүгінде оның есімін мақтанышпен алып жүр.",
                  "За вклад в национальную культуру удостоен звания «Заслуженный работник культуры Республики Казахстан» (1991), избран почётным гражданином городов Сатпаев, Кызылорда и Актобе. В 2001 году при Дворце открыт музей поэта, а само учреждение сегодня с гордостью носит его имя."
                )}
              </p>
            </div>
          </div>
