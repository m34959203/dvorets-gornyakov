...
const META = {
  kk: {
    title: "Ш. Ділдебаев атындағы тау-кеншілер сарайы — Сәтбаев",
    template: "%s · Тау-кеншілер сарайы · Сәтбаев",
    desc:
      "«Ш. Ділдебаев атындағы мәдениет және шығармашылық орталығы» КМҚК (Тау-кеншілер сарайы) — Сәтбаев қаласының мәдени орталығы, Ұлытау облысы. 22 ұжым, 3 зал, концерттер мен іс-шаралар афишасы.",
    ogLocale: "kk_KZ",
    siteName: "Ш. Ділдебаев атындағы тау-кеншілер сарайы",
